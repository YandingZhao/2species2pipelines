...
setwd('./script')
source('./core_script/harmony_process.R')
...
for (target in targets){
    ...
    integrated_list=harmony_preprocess(target_list,task_name=gsub("_","",target),batch_label=batch_label,celltype_label=celltype_label,
                                        save_prefix='../output/method_outputs/harmony/')
